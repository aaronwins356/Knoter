...
class RiskManager:
    ...
    def update_exposure(self, exposure_contracts: int, exposure_dollars: float, active_positions: int) -> None:
    ...
    def can_trade(self) -> Tuple[bool, str]:
        ...
        if self.state.trades_executed >= self.limits.max_trades_per_event:
            return False, "Max trades per event reached"
